...
<head>
	<title>Nanu's | Employee Management System</title>
	<meta charset="utf-8">
		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="content">
						<div class="header">
							<div class="logo align-center"><img src="{{ asset('/assets/images/img/logo.webp') }}" width="245" alt="shj"></div>
						...
						<form class="form-auth-small ui form" action="{{ route('login') }}" method="POST">
							...
							<button type="submit" class="ui green button large fluid primary">{{ __('SIGN IN') }}</button>
						</form>
					</div>
				</div>
			</div>
