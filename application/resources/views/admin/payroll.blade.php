@extends('layouts.default')
    ...
    @section('meta')
        <title>Reports | SHJ Time Clock</title>
            ...
            success: function(response) {
                ...
                function showdata(jsonresponse) {
                    ...
                    for (var i = 0; i < employee.length; i++) {
                        ...
                        cost=employee[i].per_day;
                        totalCost += parseFloat(employee[i].per_day) * parseFloat(employee[i].totalhours);
                        ...
                        tbody.append("<tr>"+ 
                                        ...
                                        "<td>"+employee[i].status_timein+ "/"+employee[i].status_timeout +"</td>"+
                                    "</tr>");
                    }
